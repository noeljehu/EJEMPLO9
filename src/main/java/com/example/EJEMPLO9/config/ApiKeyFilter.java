package com.example.EJEMPLO9.config;
...
@Component
@WebFilter(urlPatterns = "/api/usuarios/*")  // Aplica el filtro solo a los endpoints /api/usuarios/*
public class ApiKeyFilter implements Filter {

    @Value("${API_KEY_HEADER:user}")  // Clave del encabezado (por defecto "user")
